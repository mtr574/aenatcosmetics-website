jQuery(document).ready(function($) {
  ...
  $('.grid li').imgLiquid({horizontalAlign: 'center', verticalAlign: 'center', fill: false});

  $('.col-3 .pic').imgLiquid({horizontalAlign: 'center', verticalAlign: 'center'});

  //center/center
  $('.imgLiquid').imgLiquid();

  $('.imgLiquidCenterLeft').imgLiquid({verticalAlign: 'center', horizontalAlign: 'left'});

  $('.imgLiquidCenterRight').imgLiquid({verticalAlign: 'center', horizontalAlign: 'right'});

  $('.imgLiquidTopLeft').imgLiquid({verticalAlign: 'top', horizontalAlign: 'left'});

  $('.imgLiquidTopRight').imgLiquid({verticalAlign: 'top', horizontalAlign: 'right'});

  $('.imgLiquidTopCenter').imgLiquid({verticalAlign: 'top', horizontalAlign: 'center'});

  $('.imgLiquidBottomLeft').imgLiquid({verticalAlign: 'bottom', horizontalAlign: 'left'});

  $('.imgLiquidBottomRight').imgLiquid({verticalAlign: 'bottom', horizontalAlign: 'right'});

  $('.imgLiquidBottomCenter').imgLiquid({verticalAlign: 'bottom', horizontalAlign: 'center'});
  ...
  // Scroll To Top
  $("#back2top").scroll2Top({appearAt: 650, scrollSpeed: 200});
