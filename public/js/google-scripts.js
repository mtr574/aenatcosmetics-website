            ...
            locations: [
                {
                    ...
                    title: 'הרצליה',
                    html: [
                        '<div class="mapinfo"><h3>הרצליה</h3>',
                        '<p>המסילה 32 הרצליה</p></div>'
                    ].join(''),
                    zoom: 15
                },
                {
                    ...
                    title: 'רמת גן',
                    html: [
                        '<div class="mapinfo"><h3>רמת גן</h3>',
                        '<p>ראש פינה 10 רמת גן</p></div>'
                    ].join(''),
                    zoom: 15
                }
            ],
...
(function (g, t, f, m) {
    ...
    n = {
        html_a: function (e, a, b) {
            ...
            for (a = 0; a < this.ln; a++)this.ShowOnMenu(a) && e.append(g("<li></li>").append(n.html_a.call(this, a)));
    ...
    p = function () {
        function e(a) {
            ...
            this.o = {
                ...
                directions_options: {
                    travelMode: f.maps.TravelMode.DRIVING, unitSystem: f.maps.UnitSystem.METRIC,
                    optimizeWaypoints: !1, provideRouteAlternatives: !1, avoidHighways: !1, avoidTolls: !1
                },
        ...
        e.prototype.create_objMap =
            function () {
                var a = 0, b;
                for (b in this.o.styles)this.o.styles.hasOwnProperty(b) && (0 === a && (this.o.map_options.mapTypeControlOptions = {mapTypeIds: [f.maps.MapTypeId.ROADMAP]}), a++, this.o.map_options.mapTypeControlOptions.mapTypeIds.push("map_style_" + a));
                if (this.loaded)this.oMap.setOptions(this.o.map_options); else try {
                    this.map_div.css({
                        position: "relative",
                        overflow: "hidden"
                ...
                a = 0;
                for (b in this.o.styles)this.o.styles.hasOwnProperty(b) && (a++, this.oMap.mapTypes.set("map_style_" + a, new f.maps.StyledMapType(this.o.styles[b], {name: b})), this.oMap.setMapTypeId("map_style_" + a))
            };
        ...
        e.prototype.create_objPoint = function (a) {
            ...
            var b = a.visible === m ? m : a.visible;
            !a.type && (a.type = this.o.type);
            a.map = this.oMap;
            a.position = new f.maps.LatLng(a.lat, a.lon);
            a.zIndex = a.zIndex === m ? 1E4 : a.zIndex + 100;
            a.visible = b === m ? this.o.show_markers : b;
            this.o.maxZIndex = a.zIndex > this.maxZIndex ? a.zIndex : this.maxZIndex;
            a.image && (a.icon = new f.maps.MarkerImage(a.image, new f.maps.Size(a.image_w || 32, a.image_h || 32), new f.maps.Point(0, 0), new f.maps.Point((a.image_w || 32) / 2, (a.image_h || 32) /
                2)));
            return a
        };
        e.prototype.create_objCircle = function (a) {
            ...
            d.center = a.position;
            d.draggable = !1;
            d.zIndex = 0 < a.zIndex ? a.zIndex - 10 : 1;
            return d
        };
        e.prototype.add_markerEv = function (a, b, c) {
            ...
            f.maps.event.addListener(c, "click", function (e) {
                ...
                d.o.show_infowindows && !1 !== b.show_infowindow && d.open_infowindow(a,
                    c, e);
        ...
        e.prototype.add_dragEv = function (a, b, c) {
            ...
            f.maps.event.addListener(c, "drag", function (e) {
                var g;
                if (c.getPosition)e = c.getPosition(); else if (c.getCenter)e = c.getCenter(); else return;
                d.circles[a] && d.circles[a].setCenter(e);
                d.Polyline ? g = "Polyline" : d.Polygon && (g = "Polygon");
                if (g) {
                    for (var k = d[g].getPath().getArray(), h = [], l = 0; l < k.length; ++l)h[l] = a === l ? new f.maps.LatLng(e.lat(),
                        e.lng()) : new f.maps.LatLng(k[l].lat(), k[l].lng());
        ...
        e.prototype.add_polyEv = function (a) {
            ...
            f.maps.event.addListener(this[a].getPath(), "set_at",
                function (c, d) {
                    var e = b[a].getPath().getAt(c), e = new f.maps.LatLng(e.lat(), e.lng());
        ...
        e.prototype.create = {
            marker: function (a, b, c) {
                ...
                var a, b, c, d;
                for (a = 0; a < this.ln; a++)b = this.create_objPoint(a), "circle" == b.type && (c = this.create_objCircle(b), b.visible || (c.draggable = b.draggable), d = new f.maps.Circle(c), this.add_circleEv(a, c, d), this.circles[a] = d), b.type = "marker", this.create.marker.call(this, a, b, d)
            }, polyline: function () {
                ...
                var a = this, b, c, d = g.extend({}, this.o.stroke_options);
                d.path = [];
                ...
                var a = this, b, c, d, e, r, k = [], h = 0;
                for (b = 0; b < this.ln; b++)c = this.create_objPoint(b),
                    0 === b ? e = c.position : b === this.ln - 1 ? r = c.position : (d = !0 === this.o.locations[b].stopover ? !0 : !1, k.push({
                        location: c.position,
                        stopover: d
                ...
                this.directionsDisplay ? this.directionsDisplay.setOptions({draggable: this.o.draggable}) : this.directionsDisplay = new f.maps.DirectionsRenderer({draggable: this.o.draggable});
        ...
        e.prototype.open_infowindow = function (a, b, c) {
            ...
            c.html && this.type_to_open[d] && (this.o.beforeOpenInfowindow(a, c, b), this.type_to_open[d].call(this, c), this.infowindow.open(this.oMap,
                b), this.o.afterOpenInfowindow(a, c, b))
        };
        ...
        e.prototype.generate_controls = function () {
            if (this.o.controls_on_map) {
                var a = g('<div class="on_gmap ' + this.o.controls_type + ' gmap_controls"></div>').css(this.o.controls_applycss ? {margin: "5px"} : {}), b = g(this.get_html_controls()).css(this.o.controls_applycss ?
                {
                    background: "#fff",
                    padding: "5px",
        ...
        e.prototype.init_map = function () {
            ...
            for (var b = this.markers.length - 1; 0 <= b; --b)try {
            ...
            this.markers = [];
            for (b = this.circles.length - 1; 0 <= b; --b)try {
            ...
            this.circles = [];
            this.o.controls_on_map && this.oMap.controls &&
        ...
        e.prototype.perform_load = function () {
            1 === this.ln ? (this.o.map_options.set_center ? this.oMap.setCenter(new f.maps.LatLng(this.o.map_options.set_center[0], this.o.map_options.set_center[1])) : (this.oMap.fitBounds(this.oBounds), this.ViewOnMap(1)), this.o.map_options.zoom && this.oMap.setZoom(this.o.map_options.zoom)) :
        ...
        e.prototype.CloseInfoWindow = function () {
            this.infowindow && (this.current_index || 0 === this.current_index) && (this.o.beforeCloseInfowindow(this.current_index, this.o.locations[this.current_index]),
                this.infowindow.close(), this.infowindow = null, this.o.afterCloseInfowindow(this.current_index, this.o.locations[this.current_index]));
            return this
        };
        ...
        e.prototype.ViewOnMap = function (a) {
            if (a === this.view_all_key)this.o.beforeViewAll(), this.current_index = a, 0 < this.o.locations.length && this.o.generate_controls &&
            this.current_control && this.current_control.activateCurrent && this.current_control.activateCurrent.apply(this, [a]), this.oMap.fitBounds(this.oBounds), this.CloseInfoWindow(), this.o.afterViewAll(); else if (a = parseInt(a, 10), "number" === typeof(a - 0) && 0 < a && a <= this.ln)try {
        ...
        e.prototype.Load = function (a) {
            ...
            if (this.loaded)this.perform_load(); else {
                ...
                for (var c in this.o.listeners) {
                    var d = this.oMap, e = this.o.listeners[c];
